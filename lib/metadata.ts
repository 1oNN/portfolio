...
export const SITE_DESCRIPTION =
  "AI/ML Engineer working on semantic search, LLMs and RAG, and the latency work that puts them in production. MSc Artificial Intelligence (Merit), University of Bradford.";
