...
export const SEED_POSTS: BlogPost[] = [
  ...
  {
    id: "seed-corpus-outgrew-the-box",
    slug: "corpus-outgrew-the-box",
    title: "The corpus outgrew the box: 16 GB of jobs against 12 GB of RAM",
    excerpt:
      "Search stopped returning results and nothing had been deployed. It was not a regression and not an outage - the index had simply grown past what the machine could hold, and an 8-second statement timeout turned that into an empty page.",
    type: "case-study",
    tags: ["PostgreSQL", "Performance", "Infrastructure", "Capacity"],
    published: true,
  ...
  {
    id: "seed-250-open-streams-http2-leak",
    slug: "250-open-streams-http2-leak",
    title: "250 open streams: one hardcoded http2=True and nine hours of failed reads",
    excerpt:
      "Production reported db_ok: false from 00:45 to 10:06 UTC while the database was entirely healthy. The uptime check failed ten times in a row and was right every time.",
    type: "case-study",
    tags: ["Python", "httpx", "HTTP/2", "Debugging", "FastAPI"],
    published: true,
  ...
  {
    id: "seed-thirty-of-five-hundred-starved-band",
    slug: "thirty-of-five-hundred-starved-band",
    title: "30 of 500: the guard that reads a starved run as a healthy one",
    excerpt:
      "ATS discovery probed 500 company names and decided 30 of them. The yield guard scored that band at 20% and let it continue, because it was dividing by the wrong number.",
    type: "case-study",
    tags: ["Throughput", "Rate Limiting", "Instrumentation", "Metrics"],
    published: true,
