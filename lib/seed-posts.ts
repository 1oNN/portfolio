...
export const SEED_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      "",
      "The honest reading of 0.76 is that roughly three in four answers stay grounded and about a quarter drift. Those are not a result to admire; they are the prompt-engineering targets for the next iteration. Answer relevance at 0.74 tracks faithfulness closely, which suggests the model stays on topic when it stays grounded — the two failure modes look related, not independent.",
      "",
