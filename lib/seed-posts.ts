...
export const SEED_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      "",
      "On a 110-item benchmark spanning seven regulatory domains, the pipeline reached 0.76 faithfulness and 0.74 answer relevance, with 0.82 source accuracy and 0.81 citation quality. Source accuracy peaked at 0.85 on advanced queries - precisely the cases where graph expansion supplies regulatory hierarchy that dense retrieval alone drops.",
      "",
